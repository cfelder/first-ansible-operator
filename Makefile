...
# fz-juelich.de/first-ansible-operator-bundle:$VERSION and fz-juelich.de/first-ansible-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= fz-juelich.de/first-ansible-operator
